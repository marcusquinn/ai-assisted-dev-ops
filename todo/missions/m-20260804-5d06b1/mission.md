...
| 2026-08-07T02:24:18Z | Milestone 2 restricted OpenCode overlays completed | Implemented Feature 2.5 through PR #29673 with deterministic schema-backed descriptors, roster/source binding, bounded context injection, workload-tier routing, final fail-closed OpenCode isolation, a fixed-argv ACP launcher, security and compatibility coverage, and operator documentation. Broad suites passed, including all 556 plugin tests under `umask 0022` and all 16 launcher cases; isolated OpenCode 1.18.9 smoke preserved the exact overlay digest and reached ACP startup, while Qlty reported zero new-file smells and a regression delta of -1. |
