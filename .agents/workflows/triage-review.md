...
5. **Workload tier**: Apply `reference/task-taxonomy.md` and recommend
   `tier:simple`, `tier:standard`, or `tier:thinking`; runtime routing selects the
   model. Do not infer the tier from file, estimate, checklist, or keyword counts.
