...
`reference/team-interface-runtime.md`. Restricted and remote-interactive OpenCode
sessions use the ephemeral descriptor and final plugin boundary in
`reference/team-interface-opencode-overlays.md`; the Buzz provisioning and
identity boundary is described in `reference/team-interface-buzz-provisioning.md`.
The existing Matrix bot now uses the core event contract and static
`adapter.matrix`; direct aidevops and
...
OpenCode launch overlays are caller-owned, content-addressed, ephemeral
