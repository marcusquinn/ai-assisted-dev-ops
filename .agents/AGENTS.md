...
- Every domain retains DevOps purpose, safety and verification; repository knowledge owns durable work, not only the forge. Purpose: `.agents/aidevops/purpose.md`.
