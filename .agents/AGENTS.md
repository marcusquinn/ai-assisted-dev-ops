...
- Run long checks in the background when the runtime permits. Poll only bounded operational gates; never worker-poll post-PR CI or reviews—hand pending gates to pulse. Details: `reference/self-improvement.md`.
