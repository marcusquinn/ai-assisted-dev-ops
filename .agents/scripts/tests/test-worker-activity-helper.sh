...
assert_eq "2p: issue-scoped and live unscoped blockers remain proven current" "2" \
...
assert_contains "5k: human output shows proven current blocker count" "Proven current:              2" "$OUT"
