...
| FreshRSS | **API/Export** feed items | **API** unread and starred state | **No** | **API/Export** subscriptions | **API/Export** folders/tags | Rank 6, #29226. Google Reader API first, OPML reconciliation, Fever fallback only; dedicated API password is not read-only scoped. |
