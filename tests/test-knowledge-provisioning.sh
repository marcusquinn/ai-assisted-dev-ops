...
test_personal_mode() {
	...
	assert_file "${personal_base}/catalog.db" "3.4 personal corpus catalog created"
	assert_file "${personal_base}/_config/principal.json" "3.5 local authentication context created"
